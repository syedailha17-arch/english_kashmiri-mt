...
# Load IndicTrans2 (correct model name)
print("Loading IndicTrans2 model...")
pipe = pipeline("translation", model="ai4bharat/indictrans2-indic-en-1B", trust_remote_code=True)
model = AutoModelForSeq2SeqLM.from_pretrained("ai4bharat/indictrans2-indic-en-1B", trust_remote_code=True, device_map="auto")
tokenizer = AutoTokenizer.from_pretrained(model, src_lang="eng_Latn", tgt_lang="kas_Arab")
